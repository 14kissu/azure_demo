...
<div>
	...
	List<Customer> customerList = (List<Customer>)request.getAttribute("customers");
		...
		out.println("<table border=1 style='margin-left:35%;'>");
		out.println("<tr><th>Id</th><th>Name</th><th>EmailId</th></tr>");
		for(Customer c:customerList) {
			out.println("<tr><td>"+c.getId()+"</td><td>"+c.getName()+"</td><td>"+c.getEmail()+"</td></tr>");
		}
		out.println("</table>");
